# help to create temporary files
# import tempfile
# import os

# PIL ogiginal name of Pillow created form django
...
# recipe:recipe-list - app name: identifier inside app
RECIPES_URL = reverse('recipe:recipe-list')

# neme of custom function recipe-upload-image we will create
...
def sample_recipe(user, **params):
    ...
    # defaults fanction from python dictionary
